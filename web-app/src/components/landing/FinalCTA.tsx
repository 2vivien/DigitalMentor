    ...
    <section className="py-20 px-4">
      <div className="max-w-5xl mx-auto bg-white border-2 border-black rounded-xl p-10 sm:p-16 neo-shadow text-center relative overflow-hidden">
        ...
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className="text-xl font-bold bg-black text-white border-2 border-black px-10 py-4 rounded-lg shadow-[5px_5px_0px_0px_#FFDE00] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_#FFDE00] transition-all flex items-center justify-center gap-2 mx-auto"
        >
